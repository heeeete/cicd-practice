...
const SystemMetrics = ({ workflowRuns }) => {
	const getMetrics = () => {
		...
		return {
			...
			lastDeploy: latestSuccessful ? formatDistanceToNow(latestSuccessful.created_at) : "N/A",
	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
			<MetricCard title="Current Version" value={metrics.currentVersion} icon="🚀" />
			<MetricCard title="Last Deploy" value={metrics.lastDeploy} icon="⏱️" />
